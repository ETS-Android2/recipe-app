...
public class TinyDB {
    ...
    public ArrayList<Recipes> getListRecipe(String key){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Recipes player  = gson.fromJson(jObjString,  Recipes.class);
            recipesList.add(player);
        }
        return recipesList;
    }
...
//    }
//
    public void putListObject(String key, ArrayList<Recipes> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
