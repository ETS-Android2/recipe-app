...
public class RecipesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recipes.add(new Recipes("Chicken Roll","200 gm chopped into cubes chicken\n" +
        ...
        recipes.add(new Recipes("Donut","1 c. whole milk\n" +
                ...
                "Transfer doughnuts to paper towel-lined baking sheet to drain and cool slightly. Dip into glaze, then place onto a cooling rack (or eat immediately!)",R.drawable.donut1, false));
        recipes.add(new Recipes("Dosa","3 cups rice\n" +
                ...
                "Wash the rice and urad daal well. Add the fenugreek seeds to the mix and fill enough water in the rice-daal bowl to cover them about 2-inch deep. Soak overnight.\n" +
                        ...
                        "The dosa is almost done. Fold it in half and allow to cook for 30 seconds more.",R.drawable.dosa1, false));
        recipes.add(new Recipes("Pancake","1 1/4 cups milk" +
                "1 egg\n" +
                ...
                "In a large bowl, sift together the flour, baking powder, salt and sugar. Make a well in the center and pour in the milk, egg and melted butter; mix until smooth." +
                        "Heat a lightly oiled griddle or frying pan over medium high heat. Pour or scoop the batter onto the griddle, using approximately 1/4 cup for each pancake. Brown on both sides and serve hot.",R.drawable.pancakes, false));
        recipes.add(new Recipes("Pasta","1 tsp oil" +
                "1 tsp butter\n" +
                ...
                "firstly, saute 1 inch ginger and 2 clove garlic in 1 tsp oil and 1 tsp butter." +
                        ...
                        "finally, serve masala pasta indian style hot topped with cheese if required.",R.drawable.pasta1, false));


        RecyclerViewAdapter mAdapter = new RecyclerViewAdapter(getActivity(),recipes, showingRecipes);
